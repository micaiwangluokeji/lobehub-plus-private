export default {
  ...
  'settingAgent.official.publish': 'Publish as Official',
  'settingAgent.official.publishConfirm':
    'Publish this agent to the official marketplace? All users will be able to see and install it.',
  'settingAgent.official.publishSuccess': 'Agent published as official successfully',
  'settingAgent.official.publishFailed': 'Failed to publish agent as official',
  'settingAgent.official.unpublish': 'Unpublish from Official',
  'settingAgent.official.unpublishConfirm':
    'Remove this agent from the official marketplace? Users who already installed it will keep their copy.',
  'settingAgent.official.unpublishSuccess': 'Agent unpublished from official successfully',
  'settingAgent.official.unpublishFailed': 'Failed to unpublish agent from official',
  'settingAgent.discover.publish': 'Publish to Discover',
  'settingAgent.discover.publishConfirm':
    'Publish this agent to the discover page? All users will be able to see and install it.',
  'settingAgent.discover.publishSuccess': 'Agent published to discover successfully',
  'settingAgent.discover.publishFailed': 'Failed to publish agent to discover',
  'settingAgent.discover.unpublish': 'Unpublish from Discover',
  'settingAgent.discover.unpublishConfirm':
    'Remove this agent from the discover page? Users who already installed it will keep their copy.',
  'settingAgent.discover.unpublishSuccess': 'Agent unpublished from discover successfully',
  'settingAgent.discover.unpublishFailed': 'Failed to unpublish agent from discover',
  ...
  'settingAppearance.navVisibility.title': 'Navigation Visibility',
  'settingAppearance.navVisibility.description':
    'Control which navigation items are visible for different user roles',
  'settingAppearance.navVisibility.freeUser': 'Regular User',
  'settingAppearance.navVisibility.vipUser': 'VIP User',
  'settingAppearance.navVisibility.home': 'Home',
  'settingAppearance.navVisibility.discover': 'Discover',
  'settingAppearance.navVisibility.tasks': 'Tasks',
  'settingAppearance.navVisibility.pages': 'Pages',
  'settingAppearance.navVisibility.image': 'Generation',
  'settingAppearance.navVisibility.resource': 'Resources',
  'settingAppearance.navVisibility.memory': 'Memory',
  ...
  'settingGroup.discover.publish': 'Publish to Discover',
  'settingGroup.discover.publishConfirm':
    'Publish this group to the discover page? All users will be able to see and install it.',
  'settingGroup.discover.publishSuccess': 'Group published to discover successfully',
  'settingGroup.discover.publishFailed': 'Failed to publish group to discover',
  'settingGroup.discover.unpublish': 'Unpublish from Discover',
  'settingGroup.discover.unpublishConfirm':
    'Remove this group from the discover page? Users who already installed it will keep their copy.',
  'settingGroup.discover.unpublishSuccess': 'Group unpublished from discover successfully',
  'settingGroup.discover.unpublishFailed': 'Failed to unpublish group from discover',
...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'review.title': 'Review Management',
  'review.agentTab': 'Agent Review',
  'review.groupTab': 'Group Review',
  'review.approve': 'Approve',
  'review.reject': 'Reject',
  'review.empty': 'No pending review requests',
  'review.submitter': 'Submitter',
  'review.submitTime': 'Submitted',
  'review.approveSuccess': 'Approved',
  'review.rejectSuccess': 'Rejected',
