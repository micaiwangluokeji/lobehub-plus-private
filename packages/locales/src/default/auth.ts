export default {
  ...
  'profile.role.description.free_user': 'Can use officially published agents only.',
  'profile.role.description.vip_user': 'Can create and publish agents.',
  'profile.role.description.super_admin': 'Full system administration access.',
  'profile.role.upgrade': 'Upgrade to VIP',
  'profile.role.upgradeTooltip': 'Upgrade to VIP to create and publish your own agents.',
  'profile.save': 'Save',
