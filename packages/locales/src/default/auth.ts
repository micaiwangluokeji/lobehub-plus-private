export default {
  ...
  'profile.role.pro_user': 'Pro User',
  'profile.role.vip_user': 'VIP User',
  'profile.role.super_admin': 'Administrator',
  'profile.role.description.free_user': 'Basic usage with credit balance. Can use official agents.',
  'profile.role.description.pro_user': 'Full access: create agents, custom providers, publish to Discover.',
  'profile.role.description.vip_user': 'Legacy role — can create and publish agents.',
  'profile.role.description.super_admin': 'Full system administration access.',
  'profile.role.upgrade': 'Upgrade to Pro',
  'profile.role.upgradeTooltip': 'Upgrade to Pro to create agents, use custom providers, and publish to Discover.',
  'profile.save': 'Save',
