...
| 1.7 | 更新导航/侧边栏 visibility | `src/hooks/useNavLayout.ts`, AdminSidebar | 按 pro_user 角色显示/隐藏导航项 |
| 1.8 | 更新 i18n | `src/locales/default/admin.ts` + auth.ts | `pro_user` 角色名称和描述 |
...
| 3 | Free 用户尝试创建 agent | 前端按钮不显示，后端 403 |
