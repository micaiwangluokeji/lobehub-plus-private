...
- [FlowEngine 概述](https://docs.nocobase.com/cn/plugin-development/client/flow-engine/) — FlowModel、renderComponent、registerFlow 基础用法

- [i18n 国际化](https://docs.nocobase.com/cn/plugin-development/client/component/i18n) — 翻译文件写法和 tExpr() 延迟翻译的用法
...
这会在 `packages/plugins/@my-project/plugin-simple-block` 下生成基础文件结构。详细说明见 [编写第一个插件](https://docs.nocobase.com/cn/plugin-development/write-your-first-plugin)。
...
- `registerFlow()` — 添加配置面板。`uiSchema` 用 JSON Schema 定义表单（语法参考 [UI Schema](https://docs.nocobase.com/cn/flow-engine/ui-schema)），`handler` 把用户填写的值写入 `ctx.model.props`，`renderComponent()` 就能读到
...
关于翻译文件的写法和 `tExpr()` 的更多用法，详见 [i18n 国际化](https://docs.nocobase.com/cn/plugin-development/client/component/i18n)。
...
| 能力 | 用法 | 文档 |
|---|---|---|
| 区块渲染 | BlockModel + renderComponent() | [FlowEngine → 区块扩展](https://docs.nocobase.com/cn/plugin-development/client/flow-engine/block) |
| 菜单注册 | define({ label }) | [FlowEngine 概述](https://docs.nocobase.com/cn/plugin-development/client/flow-engine/) |
| 配置面板 | registerFlow() + uiSchema | [FlowEngine 概述](https://docs.nocobase.com/cn/plugin-development/client/flow-engine/) |
| 模型注册 | registerModelLoaders（按需加载） | [Plugin 插件](https://docs.nocobase.com/cn/plugin-development/client/plugin) |
| 延迟翻译 | tExpr() | [i18n 国际化](https://docs.nocobase.com/cn/plugin-development/client/component/i18n) |
