...
注册完成后，在表格区块里找到一个对应类型的字段列（比如上面示例绑定了 `input`，对应单行文本字段），点击列的配置按钮，在「字段组件」下拉菜单中就能切换到这个自定义展示组件。完整的实战示例见 [做一个自定义字段组件](https://docs.nocobase.com/cn/plugin-development/client/examples/custom-field)。
...
- [插件实战：做一个自定义字段组件](https://docs.nocobase.com/cn/plugin-development/client/examples/custom-field) — 从零搭建一个自定义字段展示组件

- [插件实战：做一个前后端联动的数据管理插件](https://docs.nocobase.com/cn/plugin-development/client/examples/fullstack-plugin) — 自定义字段在完整插件中的实际应用

- [FlowEngine 概述](https://docs.nocobase.com/cn/plugin-development/client/flow-engine/) — FlowModel 基础用法

- [区块扩展](https://docs.nocobase.com/cn/plugin-development/client/flow-engine/block) — 自定义区块

- [操作扩展](https://docs.nocobase.com/cn/plugin-development/client/flow-engine/action) — 自定义操作按钮

- [FlowDefinition 流定义](https://docs.nocobase.com/cn/flow-engine/definitions/flow-definition) — registerFlow 的完整参数和事件类型

- [FlowEngine 完整文档](https://docs.nocobase.com/cn/flow-engine/) — 完整参考
