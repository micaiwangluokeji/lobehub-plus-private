...
开发客户端插件之前，请确保你已经阅读了 [编写第一个插件](https://docs.nocobase.com/cn/plugin-development/write-your-first-plugin) 章节，生成了基本的插件目录结构和文件。
...
详细用法见 [Router 路由](https://docs.nocobase.com/cn/plugin-development/client/router)。
...
`registerModelLoaders` 使用按需加载（动态导入），只有在模型首次被使用时才会加载对应模块，是推荐的注册方式。详细用法见 [FlowEngine](https://docs.nocobase.com/cn/plugin-development/client/flow-engine/)。
...
更多上下文能力见 [Context 上下文](https://docs.nocobase.com/cn/plugin-development/client/ctx/)。

## 相关链接

- [Router 路由](https://docs.nocobase.com/cn/plugin-development/client/router) — 注册页面路由和插件设置页

- [Component 组件开发](https://docs.nocobase.com/cn/plugin-development/client/component/) — 路由挂载的 React 组件怎么写

- [Context 上下文](https://docs.nocobase.com/cn/plugin-development/client/ctx/) — 通过上下文使用 NocoBase 内置能力

- [FlowEngine](https://docs.nocobase.com/cn/plugin-development/client/flow-engine/) — 注册区块、字段、操作等可视化配置组件

- [编写第一个插件](https://docs.nocobase.com/cn/plugin-development/write-your-first-plugin) — 从零创建插件
