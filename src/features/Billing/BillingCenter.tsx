...
export default function BillingCenter() {
  ...
  const { data: history } = useSWR('billing:creditHistory', () =>
    creditService.listMyHistory(1, 50),
  );
    ...
    <div style={{ maxWidth: 600, margin: '0 auto', padding: 24 }}>
      ...
      >
        {(plans ?? []).map((plan: any) => (
          ...
          >
            ...
            <Button block loading={subscribing} type="primary" style={{ marginTop: 8 }}>
              订阅 →
            </Button>
          </Card>
        ))}
      ...
      >
        <Card style={{ marginBottom: 16 }}>
          <Button block onClick={handleGenerateInvite} type="primary">
            生成邀请码
          </Button>
        </Card>
      ...
      >
        <Card>
          <Statistic title="本月 Token 消耗" value="—" />
          <Text type="secondary">详细统计开发中</Text>
        </Card>
      </Modal>
